...
function test_feed_effects_1()
    ...
    lunatest.assert_equal('evo_increase: 0.073 threat: 18', effects_str(calc))
end
...
function test_feed_effects_2()
    ...
    local calc = Functions.calc_feed_effects(evo, flask_food_value, num_flasks, current_player_count, max_reanim_thresh)
    lunatest.assert_equal('evo_increase: 0.038 threat: 143', effects_str(calc))
end
...
function test_feed_effects_3()
    ...
    local calc = Functions.calc_feed_effects(evo, flask_food_value, num_flasks, current_player_count, max_reanim_thresh)
    lunatest.assert_equal('evo_increase: 0.775 threat: 77396', effects_str(calc))
end
...
function test_feed_effects_4()
    ...
    local calc = Functions.calc_feed_effects(evo, flask_food_value, num_flasks, current_player_count, max_reanim_thresh)
    lunatest.assert_equal('evo_increase: 4.220 threat: 915688', effects_str(calc))
end
...
function test_feed_effects_5()
    ...
    local flask_food_value = Tables.food_values['space-science-pack'].value * difficulty / 100
    local calc = Functions.calc_feed_effects(evo, flask_food_value, num_flasks, current_player_count, max_reanim_thresh)
    lunatest.assert_equal('evo_increase: 0.569 threat: 136500', effects_str(calc))
end
